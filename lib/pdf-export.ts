...
export function generateTaxReportPDF(
  ...
  // Add summary info
  doc.setFontSize(14);
  doc.text('Tax Deduction Summary', 14, 46);
  ...
  doc.setFontSize(14);
  doc.text('Category Breakdown', 14, doc.autoTable.previous.finalY + 10);
  ...
  // Add expense details
  doc.setFontSize(14);
  doc.text('Deductible Expense Details', 14, doc.autoTable.previous.finalY + 10);
